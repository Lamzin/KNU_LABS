...
func test_run_int8() {
    ...
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "+", "int8", 40 * 1 / t_1 * 10.0 / 1000, string_linear(t_1 * 25 / t_1), t_1 * 100 / t_1)
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "-", "int8", 40 * 1 / t_2 * 10.0 / 1000, string_linear(t_1 * 25 / t_2), t_1 * 100 / t_2)
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "*", "int8", 40 * 1 / t_3 * 10.0 / 1000, string_linear(t_1 * 25 / t_3), t_1 * 100 / t_3)
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "/", "int8", 40 * 1 / t_4 * 10.0 / 1000, string_linear(t_1 * 25 / t_4), t_1 * 100 / t_4)
    fmt.Printf("\n")
...
func test_run_int16() {
    ...
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "+", "int16", 40 * 1 / t_1 * 10.0 / 1000, string_linear(t_1 * 25 / t_1), t_1 * 100 / t_1)
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "-", "int16", 40 * 1 / t_2 * 10.0 / 1000, string_linear(t_1 * 25 / t_2), t_1 * 100 / t_2)
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "*", "int16", 40 * 1 / t_3 * 10.0 / 1000, string_linear(t_1 * 25 / t_3), t_1 * 100 / t_3)
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "/", "int16", 40 * 1 / t_4 * 10.0 / 1000, string_linear(t_1 * 25 / t_4), t_1 * 100 / t_4)
    fmt.Printf("\n")
...
func test_run_int32() {
    ...
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "+", "int32", 40 * 1 / t_1 * 10.0 / 1000, string_linear(t_1 * 25 / t_1), t_1 * 100 / t_1)
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "-", "int32", 40 * 1 / t_2 * 10.0 / 1000, string_linear(t_1 * 25 / t_2), t_1 * 100 / t_2)
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "*", "int32", 40 * 1 / t_3 * 10.0 / 1000, string_linear(t_1 * 25 / t_3), t_1 * 100 / t_3)
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "/", "int32", 40 * 1 / t_4 * 10.0 / 1000, string_linear(t_1 * 25 / t_4), t_1 * 100 / t_4)
    fmt.Printf("\n")
...
func test_run_int64() {
    ...
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "+", "int64", 40 * 1 / t_1 * 10.0 / 1000, string_linear(t_1 * 25 / t_1), t_1 * 100 / t_1)
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "-", "int64", 40 * 1 / t_2 * 10.0 / 1000, string_linear(t_1 * 25 / t_2), t_1 * 100 / t_2)
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "*", "int64", 40 * 1 / t_3 * 10.0 / 1000, string_linear(t_1 * 25 / t_3), t_1 * 100 / t_3)
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "/", "int64", 40 * 1 / t_4 * 10.0 / 1000, string_linear(t_1 * 25 / t_4), t_1 * 100 / t_4)
    fmt.Printf("\n")
...
func test_run_float32() {
    ...
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "+", "float32", 40 * 1 / t_1 * 10.0 / 1000, string_linear(t_1 * 25 / t_1), t_1 * 100 / t_1)
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "-", "float32", 40 * 1 / t_2 * 10.0 / 1000, string_linear(t_1 * 25 / t_2), t_1 * 100 / t_2)
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "*", "float32", 40 * 1 / t_3 * 10.0 / 1000, string_linear(t_1 * 25 / t_3), t_1 * 100 / t_3)
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "/", "float32", 40 * 1 / t_4 * 10.0 / 1000, string_linear(t_1 * 25 / t_4), t_1 * 100 / t_4)
    fmt.Printf("\n")
...
func test_run_float64() {
    ...
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "+", "float64", 40 * 1 / t_1 * 10.0 / 1000, string_linear(t_1 * 25 / t_1), t_1 * 100 / t_1)
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "-", "float64", 40 * 1 / t_2 * 10.0 / 1000, string_linear(t_1 * 25 / t_2), t_1 * 100 / t_2)
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "*", "float64", 40 * 1 / t_3 * 10.0 / 1000, string_linear(t_1 * 25 / t_3), t_1 * 100 / t_3)
    fmt.Printf("%s | %8s | %8.1f 10^9 | %32s | %8.3f%%\n",  "/", "float64", 40 * 1 / t_4 * 10.0 / 1000, string_linear(t_1 * 25 / t_4), t_1 * 100 / t_4)
    fmt.Printf("\n")
